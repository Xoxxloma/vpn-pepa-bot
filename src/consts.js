const webAppButton = {text: 'Магазин подписок', web_app: { url: 'https://pepavpn.ru/shop' } }
const basicKeyboard = [[webAppButton], ["Моя подписка"], ['Выбрать подписку'], ['Инструкция', 'О нас']]
...
const startInfoMessage = "<b>Добрый день, я VPN бот, рад приветствовать тебя.</b>\n\n" +
    ...
    "- <b>«Моя подписка»</b> - покажет срок действия подписки, покажет список доступных серверов и поможет получить файл .ovpn заново, если вдруг ты не сможешь его найти\n" +
